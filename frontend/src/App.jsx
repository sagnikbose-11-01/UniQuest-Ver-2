      ...
      <div className="app">
        ...
        <main className="main-content">
          <Routes>
            ...
            />
            <Route
              path="/dashboard/university/programs"
              element={<ProgramsCourses />}
            />
            <Route
              path="/dashboard/university/documents"
              element={<DocVerify />}
            />
            <Route
              path="/dashboard/university/analytics"
              element={<Analytics />}
            />
            <Route
              path="/dashboard/university/applications"
            ...
            />
            <Route
              path="/dashboard/applicant/new-application"
